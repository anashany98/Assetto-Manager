...
# 2. Open Port 3010 (Frontend - Optional if hosting production build via Nginx/etc, but for dev launch useful)
...
# Let's open 3010 just in case.
New-NetFirewallRule -DisplayName "AC Manager Frontend" -Direction Inbound -LocalPort 3010 -Protocol TCP -Action Allow -ErrorAction SilentlyContinue
