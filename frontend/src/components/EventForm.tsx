...
export default function EventForm({ initialData, onSubmit, onCancel, isLoading }: EventFormProps) {
    ...
    return (
        <div className="bg-[var(--bg-elevated)] p-6 rounded-xl shadow-2xl border border-[var(--border-default)] mb-8 animate-in slide-in-from-top-4">
            ...
            <div className="flex justify-end">
                <button
                    ...
                    disabled={isLoading}
                    className="bg-green-600 text-[var(--text-primary)] px-6 py-2 rounded-lg hover:bg-green-700 font-bold shadow-lg shadow-green-600/20 disabled:opacity-50"
                >
