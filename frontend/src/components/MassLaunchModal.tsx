    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
            <motion.div
                ...
                className="bg-[var(--bg-card)] border border-[var(--border-default)] w-full max-w-4xl max-h-[90vh] rounded-[2.5rem] overflow-hidden flex flex-col shadow-2xl shadow-blue-500/10"
            >
                {/* Header */}
                <div className="p-8 border-b border-[var(--border-default)] flex justify-between items-center bg-[var(--bg-app)]/50">
                    <div className="flex items-center gap-4">
                        <div className="p-3 bg-blue-600 rounded-2xl shadow-lg shadow-blue-600/20">
                            <Rocket className="text-[var(--text-primary)]" size={24} />
                        </div>
                        <div>
                            <h2 className="text-2xl font-black text-[var(--text-primary)] uppercase italic tracking-tighter">Lanzamiento Masivo</h2>
                    ...
                    <button onClick={onClose} className="p-2 hover:bg-[var(--bg-elevated)] rounded-xl transition-colors">
                        <X className="text-[var(--text-tertiary)] hover:text-[var(--text-primary)]" size={24} />
                    </button>
                </div>

                {/* Stepper */}
                <div className="px-8 py-4 bg-[var(--bg-card)]/50 flex items-center justify-center gap-4 border-b border-[var(--border-default)]">
                            ...
                            >
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            mode === 'practice'
                                                ? "bg-blue-600/10 border-blue-500 text-[var(--text-primary)]"
                                                : "bg-[var(--bg-elevated)]/50 border-transparent text-[var(--text-tertiary)] hover:bg-[var(--bg-card-hover)]"
                                        )}
                                    >
                                        <Activity size={32} />
                                    ...
                                    <button
                                        ...
                                        className={cn(
                                            "flex flex-col items-center gap-4 p-6 rounded-3xl border-2 transition-all",
                                            mode === 'race'
                                                ? "bg-red-600/10 border-red-500 text-[var(--text-primary)]"
                                                : "bg-[var(--bg-elevated)]/50 border-transparent text-[var(--text-tertiary)] hover:bg-[var(--bg-card-hover)]"
                                        )}
                                    >
                                        <Trophy size={32} />
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    ...
                                    <div className="space-y-3">
                                        <label className="text-xs font-black text-[var(--text-tertiary)] uppercase tracking-[0.2em] pl-2 flex items-center gap-2">
                                                ...
                                                <button
                                                    ...
                                                    className={cn(
                                                        ...
                                                        selectedCar === car.name
                                                            ? "bg-blue-600 border-blue-400 text-[var(--text-primary)] shadow-lg"
                                                            : "bg-[var(--bg-elevated)]/50 border-transparent text-[var(--text-tertiary)] hover:bg-[var(--bg-card-hover)]"
                                                    )}
                                                >
                                                    <div className="w-12 h-12 bg-[var(--bg-card)] rounded-xl overflow-hidden flex-shrink-0">
                        ...
                        {step === 2 && (
                            ...
                            >
                                <div className="flex justify-between items-center mb-4">
                                    <h3 className="text-xl font-bold text-[var(--text-primary)] uppercase flex items-center gap-3">
                                        ...
                                        <button
                                            ...
                                            className={cn(
                                                ...
                                                selectedStationIds.includes(station.id)
                                                    ? "bg-blue-600/10 border-blue-500 shadow-lg shadow-blue-500/5 text-[var(--text-primary)]"
                                                    : "bg-[var(--bg-elevated)]/50 border-[var(--border-default)] text-[var(--text-tertiary)] hover:border-gray-500"
                                            )}
                                        >
                                ...
                                {onlineStations.length === 0 && (
                                    <div className="p-8 text-center bg-[var(--bg-elevated)]/50 rounded-3xl border border-dashed border-[var(--border-default)]">
                                        <p className="text-[var(--text-tertiary)] font-bold uppercase tracking-widest">No hay estaciones online actualmente</p>
                                    </div>
                                )}
                            </motion.div>
                        )}
                        ...
                        {step === 3 && (
                            ...
                            >
                                <div className="text-center space-y-4">
                                    <h3 className="text-3xl font-black text-[var(--text-primary)] uppercase italic tracking-tighter">Resumen de Lanzamiento</h3>
                                    <p className="text-[var(--text-tertiary)]">Todo está listo para el despegue.</p>
                                </div>
                ...
                {/* Footer Controls */}
                <div className="p-8 border-t border-[var(--border-default)] bg-[var(--bg-app)]/50 flex justify-between items-center">
                    <button
                        disabled={step === 1 || isLaunching}
                        onClick={() => setStep(prev => prev - 1 as any)}
                        className="px-6 py-3 text-[var(--text-tertiary)] hover:text-[var(--text-primary)] font-bold uppercase tracking-widest disabled:opacity-0 transition-all"
                    >
                        Atrás
                    </button>
                    ...
                    {step < 3 ? (
                        <button
                            ...
                            onClick={() => setStep(prev => prev + 1 as any)}
                            className="bg-blue-600 hover:bg-blue-500 disabled:opacity-30 disabled:grayscale text-[var(--text-primary)] px-8 py-3 rounded-xl font-black uppercase tracking-widest transition-all flex items-center gap-2"
                        >
                        ...
                        <button
                            ...
                            className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 disabled:opacity-50 text-[var(--text-primary)] px-12 py-4 rounded-2xl font-black uppercase tracking-[0.2em] transition-all shadow-[0_0_30px_rgba(37,99,235,0.3)] flex items-center gap-3 relative overflow-hidden"
                        >
                            {isLaunching ? (
                                <>
    ...
    return (
        <div className="flex items-center gap-2">
            <div className={cn(
                ...
                active ? "bg-blue-600 text-[var(--text-primary)] ring-4 ring-blue-600/20" :
                    completed ? "bg-green-600 text-[var(--text-primary)]" : "bg-[var(--bg-elevated)] text-[var(--text-tertiary)]"
            )}>
                {completed ? "✓" : ""}
            </div>
            <span className={cn("text-[10px] font-black uppercase tracking-widest", active ? "text-[var(--text-primary)]" : "text-[var(--text-tertiary)]")}>
                {label}
            </span>
        </div>
    );
...
function SummaryCard({ icon: Icon, label, value, color }: { icon: any, label: string, value: string, color: 'blue' | 'red' }) {
    return (
        <div className="bg-[var(--bg-elevated)]/50 p-6 rounded-3xl border border-[var(--border-default)] text-center space-y-2">
            <Icon className={cn("mx-auto mb-2", color === 'blue' ? 'text-blue-500' : 'text-red-500')} size={24} />
            <div className="text-[10px] font-black text-[var(--text-tertiary)] uppercase tracking-widest">{label}</div>
            <div className="text-lg font-black text-[var(--text-primary)] leading-tight">{value}</div>
        </div>
    );
}
