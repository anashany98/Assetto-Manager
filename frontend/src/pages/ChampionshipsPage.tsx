...
import { Trophy, Calendar, Plus, ChevronRight, Crown } from 'lucide-react';
...
export default function ChampionshipsPage() {
    ...
    if (isLoading) return <div className="p-10 text-white text-center">Cargando campeonatos...</div>;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                {championships?.length === 0 && (
                    <div className="col-span-full py-20 text-center text-gray-500">
                        ...
                        <p>No hay campeonatos activos. ¡Crea el primero!</p>
                    </div>
                )}
            </div>
        </div>
