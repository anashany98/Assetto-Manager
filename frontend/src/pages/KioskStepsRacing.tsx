...
export const WaitingRoomRacing: React.FC<WaitingRoomRacingProps> = ({ selection, stationId, setIsLaunched, clientTokenHeaders, onExitLobby }) => {
    ...
    const { data: hardwareStatus } = useQuery({
        queryKey: ['waiting-room-racing-hardware', stationId],
